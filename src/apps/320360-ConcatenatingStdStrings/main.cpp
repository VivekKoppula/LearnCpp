...
int main()
{
	...
	*/
	...
	std::string str6{"Hello"
					 " World"
					 " Everyone.."};									// Put the literals side by side
																		// without the + in between
	std::string str7{std::string{"Hello"} + " World" + " Everyone..."}; // Turn one or both into a std::string
	...
	std::string str8{"Hello"s + " World" + " Everyone...."}; // Turn one or both into strings using the
	...
	*/
	...
	std::string str113{" Everyone......."};
	std::string str12 = str10.append(str11).append(str113);
	std::cout << "str12 : " << str12 << std::endl;

	std::string str13{std::string{"Hello"}.append(" World").append(" Everyone........")};
	...
	*/
	...
	std::string str211{"Everyone......."};
	std::string str22{str20 + ' ' + str21 + ' ' + str211}; // The space in between is a character
