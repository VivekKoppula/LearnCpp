...
int main()
{
    ...
    */
    ...
    auto func = []()
    {
        std::cout << "Hello World!. Invoking later on." << std::endl;
    };
    ...
    []()
    {
        std::cout << "Hello World! Calling the lambda directly" << std::endl;
    }();
    ...
    std::cout << "typeid(result4) : " << typeid(result4).name() << std::endl;
