...
int main()
{
    ...
    str5 = "The sky is so blue, the grass is green. Kids are running all over the place.";
    ...
    // shrink_to_fit
    std::string str10{"Hello World"}; // 11
    str10.reserve(100);

    std::cout << "str10 capacity : " << str10.capacity() << std::endl; // 100
    std::cout << "str10 size : " << str10.size() << std::endl;         // 11
    std::cout << "str10 length : " << str10.length() << std::endl;     // 11
    str10.shrink_to_fit();

    std::cout << "str10 capacity : " << str10.capacity() << std::endl; // 11
    std::cout << "str10 size : " << str10.size() << std::endl;         // 11
    std::cout << "str10 length : " << str10.length() << std::endl;     // 11
    return 0;
}